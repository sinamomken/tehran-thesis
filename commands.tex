...
\usepackage{lastpage}
% بسته‌ٔ لازم برای تغییر شماره‌گذاری صفحات پیوست‌ها
\usepackage{etoolbox}
%%%%%%%%%%%%
% بسته‌ و دستوراتی برای ایجاد لینک‌های رنگی با امکان جهش
\usepackage[unicode=true,pagebackref=true,colorlinks,linkcolor=blue,citecolor=blue]{hyperref}
...
% اگر در مراجع، آدرس وب حاوی '%' بوده و pagebackref فعال باشد، دستورات زیر باید بیایند.
\makeatletter
...
% بسته‌های مورد نیاز برای نوشتن کدها و رنگ‌آمیزی آنها
\usepackage{listings}
...
%% if (plainnat-fa or asa-fa or chicago-fa) uncomment line below:
%\usepackage{natbib}
%% else, comment line above and uncomment line below:
\let\citep\cite
%%%%%%%%%%%%%%%%%%%%%%%%%%
% فراخوانی بسته زی‌پرشین (باید آخرین بسته باشد) و تعریف قلم فارسی و انگلیسی
