...
\renewcommand{\algorithmicelsif}{\textbf{در غیر این صورت اگر}}
\renewcommand{\algorithmicendif}{\textbf{پایان شرط}}
%\renewcommand{\algorithmicstep}{\textbf{گام}}
\renewcommand{\algorithmicfor}{\textbf{برای}}
\renewcommand{\algorithmicendfor}{\textbf{پایان حلقه‌ی برای}}
\renewcommand{\algorithmicdo}{\textbf{انجام بده:}}
\renewcommand{\algorithmicwhile}{\textbf{تا زمانی که}}
\renewcommand{\algorithmicendwhile}{\textbf{پایان حلقه‌ی شرطی}}
...
\renewcommand{\algorithmicendloop}{\textbf{پایان حلقه‌ی تکرار}}
\renewcommand{\algorithmicreturn}{\textbf{بازگرداندن:}}
\renewcommand{\algorithmicprint}{\textbf{چاپ:}}
\renewcommand{\algorithmiccomment}{\textbf{\quad\quad توضیح:}}
\renewcommand{\algorithmicto}{\textbf{تا}}
\renewcommand{\algorithmicand}{\textbf{و}}
\renewcommand{\algorithmicor}{\textbf{یا}}
\renewcommand{\algorithmicxor}{\textbf{و یا}} % add better translate
\renewcommand{\algorithmicnot}{\textbf{معکوس}}
