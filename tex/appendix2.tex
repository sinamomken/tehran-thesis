...
\section{الگوریتم فارسی با ساختار پیچیده و تودرتو}
الگوریتم \ref{alg:simulation-random}، یک الگوریتم ترکیبی و تو در تو است که با کمک دستورات بسته‌ی \lr{algorithmic} نوشته شده.
...
\begin{algorithm}[ht]
	...
	\begin{algorithmic}[1]
		...
		\FOR {تمام لحاظات در بازه‌ی ۰ تا $t_{max}$}
			\FOR {تمام پیوند‌ها}
