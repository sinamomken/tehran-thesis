...
%       نمونه پایان‌نامه آماده شده با استفاده از کلاس tehran-thesis، نگارش 0.9
...
% برای حاشیه‌نویسی و کم کردن صفحات ابتدایی، گزینه draft را وارد کنید.
\documentclass[twoside,openany,msc,draft]{./tex/tehran-thesis} % draft

% فایل commands.tex را مطالعه کنید؛ چون دستورات مربوط به فراخوانی بسته زی‌پرشین و دیگر بسته‌ها و ... در این فایل قرار دارد.
\input{./tex/commands}
